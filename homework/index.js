...
var getData = function () { return __awaiter(_this, void 0, void 0, function () {
    var result, items, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch('https://api.github.com/users/ProstoVika')];
            case 1:
                result = _a.sent();
                _a.label = 2;
            case 2:
            ...
            case 4:
                err_1 = _a.sent();
                console.log("Something went wrong ".concat(err_1));
                return [3 /*break*/, 5];
...
function showAvatar() {
    return __awaiter(this, void 0, void 0, function () {
        var githubResponse, myGithub, img, response, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch('https://api.github.com/users/ProstoVika')];
                case 1:
                ...
                case 3:
                    _a.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, new Promise(function (resolve, reject) { return setTimeout(resolve, 1000); })];
                case 4:
                    response = _a.sent();
                    img.remove();
                    return [2 /*return*/, myGithub];
                case 5:
                    err_2 = _a.sent();
